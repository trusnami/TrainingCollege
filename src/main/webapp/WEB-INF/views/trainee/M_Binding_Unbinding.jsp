        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form role="form" action="/card/newcard" METHOD="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cardNumber" class="form-control"  placeholder="Enter card number">
                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="item" items="${cardList}" >
                                    <tr>
                                        ...
                                        <td><input type=button class="btn btn-block btn-warning"
                                                   onclick="location='http://localhost:8080/card/unbind?cardnumber=${item.getCardnumber()}'"
                                                   value="unbind"></td>
                                    </tr>
                                </c:forEach>
