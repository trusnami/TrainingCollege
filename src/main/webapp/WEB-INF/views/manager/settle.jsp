...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="/Manager/Home" class="logo">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">${manager.managername}</span>
                        </a>
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/Manager/Approve_Launch"><i class="fa fa-circle-o"></i>approve launch Course </a></li>

                        <li><a href="/Manager/Approve_Modify"><i class="fa fa-circle-o"></i>approve modify Course </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-share"></i> <span>Accountant</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="/Manager/Settle"><i class="fa fa-circle-o"></i> settle accounts </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/Manager/Institution_Info"><i class="fa fa-circle-o"></i> institution </a></li>

                        <li><a href="/Manager/Trainee_Info"><i class="fa fa-circle-o"></i> trainee </a></li>

                        <li><a href="/Manager/Finance_Info"><i class="fa fa-circle-o"></i> finance </a></li>
                    </ul>
                </li>
                   ...
                   <div class="col-xs-12">
                       <div class="box">
                           <div class="box-header">
                               <h3 class="box-title">course to settle</h3>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <button type="button" class="btn btn-block btn-warning "
                                                       onclick="location='http://localhost:8080/institution/addbalance?institutionid=${item.institutionid}&money=${item.money}&courseid=${item.classid}'"
