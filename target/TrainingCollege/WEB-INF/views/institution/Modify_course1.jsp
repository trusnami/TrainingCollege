                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="beginDate" class="form-control pull-right" value="<fmt:formatDate value="${course.begindate}" pattern="MM/dd/yyyy"/>" style="display:none" >
                                        <input type="text" name="endDate" class="form-control pull-right" value="<fmt:formatDate value="${course.enddate}" pattern="MM/dd/yyyy"/>" style="display:none" >
                                    </div>
                                    <!-- /.form-group -->
                                    <!-- /.form-group -->
                                    <div class="form-group">
