                ...
                <div class="col-md-4">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">course: ${courseid} - trainee score</h3>
                        ...
                        <!-- /.box-header -->
                        <form action="/score/registered" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <c:forEach var="item" items="${list}">
                                            <div class="form-group">
                                                <label>${item.traineeid}</label>
                                                <input type="number" name="${item.traineeid}" class="form-control" value="60">
                                            </div>
                                        </c:forEach>
                                        <!-- /.form-group -->
                                    </div>
