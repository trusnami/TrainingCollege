...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Course
                <small> approve modify course </small>
            </h1>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">modification to approve</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-block btn-warning "
                                                    onclick="location='http://localhost:8080/course/approveModify?logid=${item.logid}'"
                                            >approve</button>
                                        </td>
                                    </tr>
                                </c:forEach>
